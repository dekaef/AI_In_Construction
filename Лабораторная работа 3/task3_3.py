...
def count_letters(text):
    ...
    for char in text.lower():  # Приводим текст к нижнему регистру
        if char.isalpha():  # Проверяем, является ли символ буквой
            letter_count[char] = letter_count.get(char, 0) + 1  # Увеличиваем счетчик
    return letter_count
...
def calculate_frequency(letter_count):
    ...
    letter_frequency = {letter: count / total_letters for letter, count in letter_count.items()}  # Вычисляем частоту
